...
class Tip extends WebBase
{
    ...
    public final function getTKTip()
    {
        ...
        if ($data = $this->getCol($sql)) {
            ...
            if ($state == 4) {
                parent::json_fails('提款失败！<br/>原因：' . $info);
//				return array(
//					'flag'=>true,
//					'message'=>'提款失败！<br/>原因：'.$info
//				);
            } else {
                parent::json_success('提款成功！<br/>金额：' . $amount . '元');
//				return array(
//					'flag'=>true,
...
//				);
    ...
    public final function getCZTip()
    {
        ...
        if ($data = $this->getCol($sql)) {
            ...
            if ($CZAmount > 0) {
                parent::json_success('充值成功！<br>充值金额：' . $CZAmount . '元');
//				return array(
//					'flag'=>true,
//					'message'=>'充值成功！<br>充值金额：'.$CZAmount.'元'
//				);
            } else {
                parent::json_fails('扣款成功！<br>系统扣款：' . abs($CZAmount) . '元');
//				return array(
//					'flag'=>true,
...
//			);
    ...
    public final function getZNX()
    {
        ...
        if ($data = $this->getCol($sql)) {
            ...
            parent::json_success('您有新的短消息,请注意查收!<br />');
